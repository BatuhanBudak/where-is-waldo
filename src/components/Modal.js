...
export default function Modal() {
  const {imageList, modalMode, startGame,modalOpen} = useContext(GameControllerContext);
  
  if( modalOpen && modalMode === "start" ){
    return  (<StyledModal><StartDialogue imageList={imageList} startGame={startGame}/></StyledModal>)
  }
